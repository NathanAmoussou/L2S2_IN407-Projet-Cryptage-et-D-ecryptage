...
""" GUI3 = CanvasArbreHuffman(tk.Tk(), arbre2)
GUI3.pack(fill=tk.BOTH, expand=1)
GUI3.afficher()
GUI3.mainloop() """
...
class GUI(tk.Tk):
    ...
    def __init__(self):
        ...
        texte_a_coder = ""
        #arbre_a_representer = ArbreB(Sommet(0, None))
        sommet_a = Sommet(8, "A")
        sommet_b = Sommet(2, "B")
        sommet_c = Sommet(7, "C")
        arbre_a_representer = ArbreB(sommet_a)
        arbre_a_representer += ArbreB(sommet_b)
        arbre_a_representer += ArbreB(sommet_c)
        arbre_a_representer += ArbreB(Sommet(1, "D"))
        arbre_a_representer += ArbreB(Sommet(8, "E"))
        arbre_a_representer += ArbreB(Sommet(6, "F"))
        arbre_a_representer += ArbreB(Sommet(8, "G"))
        arbre_a_representer += ArbreB(Sommet(0, "H"))
        arbre_a_representer += ArbreB(Sommet(4, "I"))
        arbre_a_representer += ArbreB(Sommet(9, "J"))
        ...
        self.canvas_arbre_huffman = CanvasArbreHuffman(self, arbre_a_representer)
        ...
        #self.canvas_arbre_huffman.pack(expand=True, fill=BOTH)
